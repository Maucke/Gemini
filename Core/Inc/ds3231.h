...
#define DS3231_SCL_H() HAL_GPIO_WritePin(GPIOB, DS3231_SCL_Pin, GPIO_PIN_SET)
#define DS3231_SCL_L() HAL_GPIO_WritePin(GPIOB, DS3231_SCL_Pin, GPIO_PIN_RESET)

#define DS3231_SDA_H() HAL_GPIO_WritePin(GPIOB, DS3231_SDA_Pin, GPIO_PIN_SET)
#define DS3231_SDA_L() HAL_GPIO_WritePin(GPIOB, DS3231_SDA_Pin, GPIO_PIN_RESET)

#define DS3231_IN_SDA() HAL_GPIO_ReadPin(GPIOB, DS3231_SDA_Pin)
...
extern u8 DS3231_US_Buf[7];	//时间日历数据缓存
extern u8 DS3231_Init_Buf[7];
/******************************************************************************
                                  参数宏定义                       
******************************************************************************/

//#define DS3231_YEARDATA                  (u16)0x2018	//年结构，如果是19xx年、21xx年的话请修改这个数值即可
...
void DS3231_Time_Init(u8 *Time_ch);	//时间日历初始化
